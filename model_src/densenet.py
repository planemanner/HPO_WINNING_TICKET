...
def make_densenet(growth_rate=12, num_layers=100, num_classes=10):
    return DenseNet(growth_rate=growth_rate, num_layers=num_layers, theta=0.5, drop_rate=0.2, num_classes=num_classes)
