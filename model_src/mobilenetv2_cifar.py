...
class MobileNetV2_CIFAR(nn.Module):
    def __init__(
        ...
        features: List[nn.Module] = [
            ConvNormActivation(input_image_channels, input_channel, stride=1, norm_layer=norm_layer, activation_layer=nn.ReLU6)
        ]
...
# model_2 = MobileNetV2_CIFAR(num_classes=10)
# sample = torch.randn(1, 3, 128, 128)
# print(model(sample).argsort())
# print(model_2(sample).argsort())