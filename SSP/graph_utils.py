...
def resize_graph(dot, size_per_element=0.15, min_size=12):
    """
    Resize the graph according to how much content
    it contains. Modify the graph in place.
    """
...
class small_model(nn.Module):
    def __init__(self):
        ...
        self.l_1 = nn.Linear(8, 16)
        self.l_2 = nn.Linear(8, 16)
        self.l_3 = nn.Linear(8, 16)
        self.merge = nn.Linear(16, 1)
